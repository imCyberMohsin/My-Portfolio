...
const Services = () => {
    ...
    return (
        <section id="services" className="min-h-screen dark:bg-zinc-900 bg-zinc-300 dark:text-white text-zinc-800 py-12 pb-10 px-6 md:px-20">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                    {servicesData.map(({ id, service, icon: Icon, info }) => (
                        ...
                        <div
                            key={id}
                            className="relative max-w-xs dark:bg-zinc-800 bg-zinc-200 text-center rounded-xl p-8 shadow-md hover:shadow-md hover:shadow-primary transition duration-300 ease-in-out cursor-pointer mx-auto"
                        >
                            {/* Gradient Top Border */}
